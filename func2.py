...
def is_image_dark(image_bytes, threshold=10):
    ...
    try:
        ...
        return True  # якщо не змогли відкрити, вважаємо темним

def download_sentinel_image(TOKEN, date: str, save_folder: str = "cache"):
...
# Example usage:
info = download_sentinel_image(TOKEN, "2025-06-01")
print(info)
